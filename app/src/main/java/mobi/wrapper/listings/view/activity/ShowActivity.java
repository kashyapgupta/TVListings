...
import mobi.wrapper.listings.view.adapter.EpisodesRecyclerViewAdapter;
import mobi.wrapper.listings.view.adapter.PeopleRecyclerViewAdapter;
import mobi.wrapper.listings.view.adapter.SeasonsRecyclerViewAdapter;
import mobi.wrapper.listings.view.adapter.TVShowsRecyclerViewAdapter;
import mobi.wrapper.listings.view.adapter.VideosRecyclerViewAdapter;
import mobi.wrapper.listings.view.callback.DisplayEpisodes;
